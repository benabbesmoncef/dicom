...
from .serializers import PatientRegistrationSerializer, UserLoginSerializer, TokenSerializer, MedecinRegistrationSerializer
...
class MedecinRegistrationAPIView(CreateAPIView):
        authentication_classes = ()
        permission_classes = ()
...
class UserTypeViewSet(APIView):
    def post(self, request, *args, **kwargs):
        ...
        user_obj= Subscriber.objects.get(pk=user_id)
        return Response(PatientRegistrationSerializer(user_obj).data)

class ListUsersViewSet(APIView):
    def get(self, request, format=None):
        """
        Return a list of all users.
        """
        usernames = [user.last_name for user in Subscriber.objects.all()]
